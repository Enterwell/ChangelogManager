...
async function run() {
  try {
    ...
    let input_setVersionFlag: boolean = tl.getBoolInput('setVersionFlag');
    ...
    console.log('Input set version flag: ' + input_setVersionFlag);
    ...
    try {
      ...
      let setVersionOption = input_setVersionFlag ? `-sv${setVersionProjectFilePath}` : null;
